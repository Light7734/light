...
enum T : VkFlags // NOLINT
{
	...
	all_bits = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT    // NOLINT
	           | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT, // NOLINT
};
};
...
[[nodiscard]] auto Gpu::get_properties() const -> Properties
{
	...
	properties.limits = Gpu::Limits {
        ...
        .max_compute_work_group_count = { vk_limits.maxComputeWorkGroupCount[0], vk_limits.maxComputeWorkGroupCount[1], vk_limits.maxComputeWorkGroupCount[2] },
        .max_compute_work_group_invocations = vk_limits.maxComputeWorkGroupInvocations,
        .max_compute_work_group_size = { vk_limits.maxComputeWorkGroupSize[0], vk_limits.maxComputeWorkGroupSize[1], vk_limits.maxComputeWorkGroupSize[2] },
        ...
        .max_viewport_dimensions = { vk_limits.maxViewportDimensions[0], vk_limits.maxViewportDimensions[1] },
        .viewport_bounds_range = { vk_limits.viewportBoundsRange[0], vk_limits.viewportBoundsRange[1] },
        ...
        .point_size_range = { vk_limits.pointSizeRange[0], vk_limits.pointSizeRange[1] },
        .line_width_range = { vk_limits.lineWidthRange[0], vk_limits.lineWidthRange[1] },
